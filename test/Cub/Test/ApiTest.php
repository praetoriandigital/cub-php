...
class Cub_Test_ApiTest extends Cub_Test_TestCase
{
    ...
    {
        $this->expectException(Cub_Unauthorized::class);
    ...
    {
        $this->expectException(Cub_MethodNotAllowed::class);
        Cub_Api::request('put', '');
    }
    public function testWrongResponse()
    {
        $this->expectException(Cub_ApiError::class);
        Cub_Config::$api_url = 'https://cub.policeone.com/';
        Cub_Api::get('');
    }
    public function testApiWrongUrl()
    {
        $this->expectException(Cub_NotFound::class);
    ...
    {
        $this->expectException(Cub_BadRequest::class);
